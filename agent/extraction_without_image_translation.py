...
import argparse
from utils.utils import get_question_biochar_multi, get_question_biochar_multi_pdf_threadpool_without_image_translator
...
def run():
    ...
    get_question_biochar_multi_pdf_threadpool_without_image_translator(
        data_list,
        args.model, 
        args.output_path,

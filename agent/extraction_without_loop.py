...
import argparse
from utils.utils import get_question_biochar_multi_without_loop, get_question_biochar_multi_without_loop_threadpool
...
def run():
    ...
    get_question_biochar_multi_without_loop_threadpool(
        data_list,
        args.model, 
        args.output_path,

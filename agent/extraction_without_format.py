...
import argparse
from utils.utils import get_question_biochar_multi_without_format, get_question_biochar_multi_without_format_threadpool
...
def run():
    ...
    get_question_biochar_multi_without_format_threadpool(
        data_list,
        args.model, 
        args.output_path,

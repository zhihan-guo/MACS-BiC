...
1.5. What is the mass ratio of biochar in biochar-integrated construction materials? If this value is not provided directly in the given text, it is calculated by dividing the biochar mass by the total mass of the mixture. Provide the answer of a floating number, rounded to four decimal places. Example format: 0.0083. 
